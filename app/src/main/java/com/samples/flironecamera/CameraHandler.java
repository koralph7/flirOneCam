...
class CameraHandler {
    ...
    CameraHandler(MyInterface myInterface){
    ...
    private final Camera.Consumer<ThermalImage> handleIncomingImage = new Camera.Consumer<ThermalImage>() {
        ...
        public void accept(ThermalImage thermalImage) {
...

            {
                ...
                //thermalImage.getMeasurements().addSpot(100, 100);
//                thermalImage.getImageParameters();
//                thermalImage.getScale();
              ...
              double d =  thermalImage.getValueAt(point);
